        ...
        for block in self.block_array:
            ...
            for row_index in range(len(block.matrix[0])):
                ...
                for col_index in range(self.vector_size):
                    out = block.matrix[col_index][row_index] * vector[col_index]
                    num += out
